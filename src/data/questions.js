export const questions = [
  {
    ...
    options: [
      'Solto e preso apenas por elástico',
      'Apenas preso em rabo de cavalo',
      'Em penteado tipo coque e com touca',
      'Coberto por boné',
    ],
  ...
  },
  {
    ...
    options: [
      'Pendurado para fora da camisa',
      'No bolso da calça',
      'Para dentro da camiseta',
      'No bolso do colete',
    ],
  ...
  },
  {
    ...
    options: [
      ...
      'Evitar que sejam puxados pelas esteiras',
      'Facilitar a identificação do colaborador',
    ],
  ...
  },
  {
    ...
    options: [
      'Óculos e capacete',
      'Máscara e avental',
      'Luvas, botas de segurança e capacete de proteção',
  ...
  },
  {
    ...
    options: [
      'Permitido apenas para mulheres',
      'Permitido se estiver usando luvas',
      'Permitido em áreas administrativas',
      'Proibido',
    ],
  ...
  },
  {
    ...
    options: [
      'Continuar operando com cuidado',
      'Desligar e religar a esteira',
      'Chamar alguém da manutenção e nunca tentar desobstruir',
      'Avisar os colegas e continuar o trabalho',
    ],
  ...
  },
  {
    ...
    options: [
      'Alarme de incêndio',
      'Rádio comunicador',
      'Botoeira ou corda de emergência',
      'Chave geral da operação',
    ],
  ...
  },
  {
    ...
    options: [
      'Colocar a mão rapidamente',
      'Subir na esteira',
      'Utilizar a haste auxiliar e nunca ultrapassar a proteção',
      'Pedir para outro colaborador retirar manualmente',
    ],
  ...
  },
  {
    ...
    options: [
      'Trabalhar em dupla',
      'Utilizar luvas',
      'Apoiar as mãos, sentar ou subir nos módulos',
  ...
  },
  {
    ...
    options: [
      'Andar de costas',
      'Correr para agilizar',
      'Verificar se a área está livre para circulação e sempre puxar, nunca empurrar',
      'Empurrar o equipamento rapidamente',
    ],
  ...
  },
  {
    ...
    options: [
      ...
      '7 paletes',
      '8 paletes',
      '10 paletes empilhados ou 15 entrelaçados',
    ],
  ...
  },
  {
    ...
    options: [
      'Por uma pessoa',
      'Por até três pessoas',
      'Sempre por duas pessoas e utilizando luvas',
      'Apenas pelo líder da área',
    ],
  ...
  },
  {
    ...
    options: [
      'Auxiliar o motorista na ré',
      'Ficar atrás do caminhão',
      'Subir na doca para orientar',
      'Não auxiliar o motorista nas manobras',
    ],
  ...
  },
  {
    ...
    options: [
      'Gaiolas cheias e vazias devem ser empurradas',
      'Gaiolas cheias e vazias devem ser puxadas',
      'Gaiolas vazias devem ser empurradas e gaiolas cheias devem ser puxadas',
      'É permitido movimentar duas gaiolas ao mesmo tempo',
    ],
  ...
  },
  {
    ...
    options: [
      'Abrir a caixa para verificar',
      'Levar a caixa para fora da operação',
      'Jogar a caixa fora imediatamente',
      'Não movimentar a caixa e acionar a brigada DHL',
    ],
  ...
  },
  {
    ...
    options: [
      'Avisar apenas os colegas',
      'Comunicar no final do expediente',
      'Registrar somente se houver afastamento',
      'Comunicar imediatamente ao líder DHL e à Segurança do Trabalho',
    ],
  ...
  },
  {
    ...
    options: [
      'Andar pelo caminho mais curto',
      'Circular próximo às máquinas',
      'Utilizar sempre a faixa de pedestres sinalizada',
      'Caminhar pela área de carga e descarga',
    ],
  ...
  },
  {
    ...
    options: [
      'Permitido fora do expediente',
      'Permitido mediante autorização médica',
      'Tolerado em pequenas quantidades',
      'Proibido, devendo o líder DHL ser comunicado imediatamente',
    ],
  ...
  },
  {
    ...
    options: [
      ...
      'Apenas colaboradores treinados, certificados e habilitados',
    ],
